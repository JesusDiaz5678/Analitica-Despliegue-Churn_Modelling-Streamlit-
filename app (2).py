...
balance = st.slider('Balance', min_value=0.0, max_value=250000.0, value=10000.0, step=10.0)
...
data = pd.DataFrame(datos, columns=['Geography', 'Gender', 'Age', 'Balance', 'NumOfProducts', 'IsActiveMember']) #Dataframe con los mismos nombres de variables
